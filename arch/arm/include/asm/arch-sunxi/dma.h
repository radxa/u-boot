...
#define DMAC_CFG_SRC_TYPE_NAND (5)
	...
	defined(CONFIG_MACH_SUN55IW5) || defined(CONFIG_MACH_SUN60IW2)
...
typedef struct {
	...
	defined(CONFIG_MACH_SUN50IW2) || defined(CONFIG_MACH_SUN60IW1) ||      \
	defined(CONFIG_MACH_SUN60IW2) || defined(CONFIG_MACH_SUN55IW6) ||      \
	defined (CONFIG_MACH_SUN20IW5)
typedef struct {
...
#if defined(CONFIG_MACH_SUN60IW2) || defined(CONFIG_MACH_SUN55IW6)
    #define DMA_VERSION_V2
#endif
...
#endif
#if defined(CONFIG_MACH_SUN55IW5)
	unsigned int reserved0[2];
#endif
...
#elif defined(CONFIG_MACH_SUN55IW5)
	unsigned int reserved1[3];
#elif defined(DMA_VERSION_V2)
	unsigned int irq_en_reg;
	unsigned int irq_pend_reg;
	unsigned int desc_hig_addr;
#else
	unsigned int reserved1[5];
#endif
