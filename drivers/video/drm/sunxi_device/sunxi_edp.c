...
static void edp_phy_set_lane_para(struct edp_tx_core *edp_core)
{
	...
	if (edp_core->combo_phy)
		generic_phy_configure(edp_core->combo_phy, &dp_opts);

	if (edp_core->dp_phy)
		generic_phy_configure(edp_core->dp_phy, &dp_opts);
}
