 ...
 */
struct blk_desc *aw_blk_get_devnum_by_typename(const char *if_typename, int devnum)
{
		      ...
		      lbaint_t blkcnt, void *buffer)
{
	...
	if (ret)
		return ret;
	n = aw_blk_dread(desc, start, blkcnt, buffer);
	if (IS_ERR_VALUE(n))
		return n;
		       ...
		       lbaint_t blkcnt, const void *buffer)
{
	...
	if (ret)
		return ret;
	return aw_blk_dwrite(desc, start, blkcnt, buffer);
}
